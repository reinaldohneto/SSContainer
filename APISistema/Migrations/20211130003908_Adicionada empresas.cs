...
{
    public partial class Adicionadaempresas : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmpresaVendedoraId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pedidos_Empresas_EmpresaVendedoraId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JoinEmpresas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JoinEmpresas_Cliente_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "Cliente",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JoinEmpresas_Empresas_EmpresaVendedoraId",
                        column: x => x.EmpresaVendedoraId,
                        principalTable: "Empresas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JoinEmpresas_Pedidos_PedidoId",
                        column: x => x.PedidoId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SerieNF = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JoinEmpresas_ClienteId",
                table: "JoinEmpresas",
                column: "ClienteId");

            migrationBuilder.CreateIndex(
                name: "IX_JoinEmpresas_EmpresaVendedoraId",
                table: "JoinEmpresas",
                column: "EmpresaVendedoraId");

            migrationBuilder.CreateIndex(
                name: "IX_JoinEmpresas_PedidoId",
                table: "JoinEmpresas",
                column: "PedidoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pedidos_EmpresaVendedoraId",
                table: "Pedidos",
                column: "EmpresaVendedoraId");
        }
